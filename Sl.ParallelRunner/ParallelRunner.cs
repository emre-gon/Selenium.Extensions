...
namespace Sl.ParallelRunner
{
    ...
    public class ParallelRunner<T>
    {
        ...
        public IParallelRunnable<T> Spider { get; }
        ...
        public virtual void Run(ILogger Logger = null)
        {
            lock (runLock)
            {
                ...
                if (Logger != null)
                    Logger.LogInformation($"Running parallel with {this.ParallelTaskCount} threads.");
